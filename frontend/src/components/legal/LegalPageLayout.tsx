...
export function LegalSection({ title, children }: LegalSectionProps) {
  return (
    <div className="space-y-3">
      <h2 className="font-display font-semibold text-sm text-slate-200 uppercase tracking-wider border-l-2 border-cyber-cyan pl-3">
        {title}
      </h2>
      <div className="text-sm text-slate-400 leading-relaxed space-y-2 font-sans pl-3">
        {children}
      </div>
    </div>
  );
...
export function LegalPageLayout({
  ...
  return (
    <div className="w-full min-h-[calc(100vh-160px)] py-6 text-left space-y-10">
      {/* HEADER */}
      <div className="border-b border-white/[0.04] pb-6 space-y-4">
        ...
        <p className="font-sans text-slate-400 text-sm mt-2 max-w-2xl leading-relaxed">
          {subtitle}
        </p>
      ...
      {/* LEGAL NAV */}
      <div className="flex flex-wrap gap-2 border border-white/[0.04] bg-[#0c0c0c] p-3">
        ...
        <div className="ml-auto">
          <Link
            to="/"
            className="flex items-center gap-1.5 px-3 py-1.5 font-mono text-[10px] uppercase tracking-wider border border-white/[0.06] text-slate-500 hover:border-slate-600 hover:text-slate-300 transition-all"
          >
      ...
      <div className="border-t border-white/[0.04] pt-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <Link
            to="/register"
            className="flex items-center gap-1.5 px-4 py-2 border border-white/[0.06] text-slate-400 hover:border-slate-600 hover:text-slate-200 text-xs font-mono uppercase tracking-wider transition-all"
          >
            Create Account
          </Link>
        </div>
